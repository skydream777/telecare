        ...
        <div class="fullwidthabnner">
            <ul id="revolutionul">
                ...
                <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="<?=base_url()?>assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
                    ...
                    <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/bg9.jpg" alt="">
                    ...
                    <div class="caption lfb"
                         ...
                         data-start="1000"
                         data-easing="easeOutExpo">
                        <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/lady.png" alt="Image 1">
                    </div>
                </li>
                ...
                <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="<?=base_url()?>assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
                    <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
                    <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/bg1.jpg" alt="">
                ...
                <!-- THE SECOND SLIDE -->
                <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-delay="9400" data-thumb="<?=base_url()?>assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
                    <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/bg2.jpg" alt="">
                    ...
                    <div class="caption lfr slide_item_right"
                        ...
                        <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/mac.png" alt="Image 1">
                    </div>
                    <div class="caption lfr slide_item_right"
                         data-x="580"
                         data-y="245"
                         ...
                         data-start="2000"
                         data-easing="easeOutBack">
                        <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/ipad.png" alt="Image 1">
                    </div>
                    <div class="caption lfr slide_item_right"
                         data-x="735"
                         data-y="290"
                         ...
                         data-start="2500"
                         data-easing="easeOutBack">
                        <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/iphone.png" alt="Image 1">
                    </div>
                    <div class="caption lfr slide_item_right"
                         data-x="835"
                         data-y="230"
                         ...
                         data-start="3000"
                         data-easing="easeOutBack">
                        <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/macbook.png" alt="Image 1">
                    </div>
                    <div class="caption lft slide_item_right"
                         ...
                         data-start="5000"
                         data-easing="easeOutBack">
                        <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/hint1-red.png" id="rev-hint1" alt="Image 1">
                    </div>
                    <div class="caption lfb slide_item_right"
                         ...
                         data-start="5500"
                         data-easing="easeOutBack">
                        <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/hint2-red.png" id="rev-hint2" alt="Image 1">
                    </div>
                </li>

                <!-- THE THIRD SLIDE -->
                <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="<?=base_url()?>assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
                    <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/bg3.jpg" alt="">
                ...
                <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="<?=base_url()?>assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
                    <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
                    <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/bg4.jpg" alt="">
                    ...
                    <div class="caption lft start"
                         ...
                         data-start="2000"
                         data-easing="easeOutBack"  >
                        <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/iphone_left.png" alt="Image 2">
                    </div>
                    ...
                    <div class="caption lft start"
                         ...
                         data-start="2400"
                         data-easing="easeOutBack"  >
                        <img src="<?=base_url()?>assets/frontend/pages/img/revolutionslider/iphone_right.png" alt="Image 3">
                    </div>
                </li>
            </ul>
                    ...
                    <div class="carousel-inner">
                        <div class="active item">
                            ...
                            <div class="carousel-info">
                                <img class="pull-left" src="<?=base_url()?>assets/frontend/pages/img/people/img1-small.jpg" alt="">
                                <div class="pull-left">
                        ...
                        <div class="item">
                            ...
                            <div class="carousel-info">
                                <img class="pull-left" src="<?=base_url()?>assets/frontend/pages/img/people/img5-small.jpg" alt="">
                                <div class="pull-left">
                        ...
                        <div class="item">
                            ...
                            <div class="carousel-info">
                                <img class="pull-left" src="<?=base_url()?>assets/frontend/pages/img/people/img2-small.jpg" alt="">
                                <div class="pull-left">
            ...
            <div class="col-md-9">
                <div class="owl-carousel owl-carousel6-brands">
                    <div class="client-item">
                        <a href="javascript:;">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_1_gray.png" class="img-responsive" alt="">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_1.png" class="color-img img-responsive" alt="">
                        </a>
                    </div>
                    <div class="client-item">
                        <a href="javascript:;">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_2_gray.png" class="img-responsive" alt="">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_2.png" class="color-img img-responsive" alt="">
                        </a>
                    </div>
                    <div class="client-item">
                        <a href="javascript:;">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_3_gray.png" class="img-responsive" alt="">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_3.png" class="color-img img-responsive" alt="">
                        </a>
                    </div>
                    <div class="client-item">
                        <a href="javascript:;">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_4_gray.png" class="img-responsive" alt="">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_4.png" class="color-img img-responsive" alt="">
                        </a>
                    </div>
                    <div class="client-item">
                        <a href="javascript:;">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_5_gray.png" class="img-responsive" alt="">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_5.png" class="color-img img-responsive" alt="">
                        </a>
                    </div>
                    <div class="client-item">
                        <a href="javascript:;">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_6_gray.png" class="img-responsive" alt="">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_6.png" class="color-img img-responsive" alt="">
                        </a>
                    </div>
                    <div class="client-item">
                        <a href="javascript:;">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_7_gray.png" class="img-responsive" alt="">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_7.png" class="color-img img-responsive" alt="">
                        </a>
                    </div>
                    <div class="client-item">
                        <a href="javascript:;">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_8_gray.png" class="img-responsive" alt="">
                            <img src="<?=base_url()?>assets/frontend/pages/img/clients/client_8.png" class="color-img img-responsive" alt="">
                        </a>
                    </div>
                </div>
            </div>
